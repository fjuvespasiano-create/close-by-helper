...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sua conta gratuita no AgendaAqui: avalie empresas, salve favoritos e gerencie seu negócio na cidade. Leva menos de 1 minuto." },
    ...
    <SiteLayout>
      <div className="container mx-auto flex max-w-md flex-col px-4 py-16">
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm md:p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sua conta grátis para avaliar empresas, salvar favoritos e cuidar do seu negócio na cidade.</p>
